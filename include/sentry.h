...
SENTRY_EXPERIMENTAL_API int sentry_log_trace(const char *message, ...);
SENTRY_EXPERIMENTAL_API int sentry_log_debug(const char *message, ...);
SENTRY_EXPERIMENTAL_API int sentry_log_info(const char *message, ...);
SENTRY_EXPERIMENTAL_API int sentry_log_warn(const char *message, ...);
SENTRY_EXPERIMENTAL_API int sentry_log_error(const char *message, ...);
SENTRY_EXPERIMENTAL_API int sentry_log_fatal(const char *message, ...);
