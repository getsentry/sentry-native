    ...
    sentry_value_t attachment, const char *path, size_t path_len)
{
    ...
    sentry_value_set_by_key(attachment, ATTACHMENT_FILENAME,
        sentry_value_new_string_n(filename, filename_len));
}
...
static bool
attachment_id_eq(sentry_value_t a, sentry_value_t b)
{
