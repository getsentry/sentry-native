...
/**
 * Merges attachments with local-scope and global-scope attachments.
 *
 * Returns an owned value that the caller must release or transfer.
 */
sentry_value_t sentry__merge_attachments(
 ...
 */
sentry_value_t sentry__before_send(
