...
SENTRY_TEST(gpu_info_vendor_id_known)
{
    ...
    // vendors
    unsigned int test_vendor_ids[] = { 0x10DE, 0x1002, 0x8086, 0x106B, 0x1414,
        0x5143, 0x13B5, 0x144D, 0x1AE0, 0x1010, 0x1023, 0x102B, 0x121A, 0x18CA,
        0x1039, 0x126F, 0x0000, 0xFFFF };
