...
- `initial-scope`: Configures test data on the initial scope before SDK initialization.
- `initial-scope-payload`: Adds a breadcrumb and attachments to the initial scope test data.
